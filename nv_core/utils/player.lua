...
RegisterNetEvent("nv_core:DisplayCashValue")
AddEventHandler("nv_core:DisplayCashValue", function(value)
	StatSetInt("MP0_WALLET_BALANCE", value, false)
	ShowHudComponentThisFrame(4)
	CancelEvent()
end)

RegisterNetEvent("nv_core:DisplayBankValue")
AddEventHandler("nv_core:DisplayBankValue", function(value)
	StatSetInt("BANK_BALANCE", value, true)
	ShowHudComponentThisFrame(3)	
	CancelEvent()
end)

RegisterNetEvent('nv_core:refresh_inventory')
AddEventHandler('nv_core:refresh_inventory', function(array)
